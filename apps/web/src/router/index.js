...
const routes = [
    ...
    {path: "/space/:spaceId/publication/:id", component: PublicationView, meta: {workspace: true, requiresAuth: true}},
    ...
    {path: "/settings", component: SettingsView, meta: {workspace: true, requiresAuth: true}},
